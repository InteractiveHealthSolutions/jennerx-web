...
package org.ird.unfepi.utils.date;
...
public class DateUtils {
	 ...
	 *
	 * @param date the date
	 * @param daysToSubttract the days to subttract
	 * @return the date
	 */
	@Deprecated
	/**
	 ...
	 * Gets the past date.
	 *
	 * @param yearsbefore the yearsbefore
	...
	/**
	 * Gets the difference of hours.
	 *
	 * @param date1 the date1
	 * @param date2 the date2
	 * @return the difference of hours
	 */
	@Deprecated
	/**
	...
	/**
	 * Gets the num of years.
	 *
	 * @param pastDate the past date
	 * @return the num of years
	 */
	@Deprecated
	/**
	 * Use DateUtils.differenceBetweenIntervals(Date @dategreater,Date datelesser,TIME_INTERVAL timeInterval) instead.
	...
	/**
	 * Gets the num of weeks passed.
	 *
	 * @param pastdate the pastdate
	 * @return the num of weeks passed
	 */
	@Deprecated
	/**
	 * Use DateUtils.differenceBetweenIntervals(Date @dategreater,Date datelesser,TIME_INTERVAL timeInterval) instead.
