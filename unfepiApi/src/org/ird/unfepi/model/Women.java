...
public enum WOMENSTATUS {
		...
		private WOMENSTATUS(String representation) {
			this.REPRESENTATION = representation;
		}
		
		public static WOMENSTATUS findEnum(String representationString){
			for (WOMENSTATUS en : WOMENSTATUS.values()) {
	...
	@ForeignKey(name = "women_mappedId_idmapper_mappedId_FK")
	...
	@ForeignKey(name = "women_enrVaccId_vaccine_vaccId")
	...
	@ForeignKey(name = "women_createdByUserId_user_mappedId_FK")
	...
	@ForeignKey(name = "women_lastEditedByUserId_user_mappedId_FK")
