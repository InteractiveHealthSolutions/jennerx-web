...
public class ResponseElements
{
	...
	public static final String UV_CHILD_VACCINATION_DUE_DATE = new String("dueDate");
	public static final String UV_VACCINE_ID = new String("vaccineID");
	public static final String VERIFICATION_CODE_FOR_MOTHER = new String("codeForMother");
	...
	public static final String SMS_REMINDER_APPROVAL = new String("smsReminderApproval");
	...
	public static final String CHILD_DOB_IN_MILLIS = new String("childDOBInMillis");
