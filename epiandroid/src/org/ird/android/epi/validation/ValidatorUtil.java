...
public class ValidatorUtil extends Activity
{
	 ...
	 * @param control The UI element ie View that has failed validation
	 * @param activity the activity making the request
	 * @param result the ValidatorResult object which contains the error mesage and whether this
	...
	*/
	...
	{
		if((userName == null)||(!userName.matches(Regex.ALPHA_NUMERIC.toString())))
	...
	{
		if((password== null)||(!password.matches(Regex.ALPHA_NUMERIC.toString())))
