...
$.fn.sooperfish = function(op) {
  ...
  sf.defaults = {
    multiColumn  : true,
    dualColumn  : 9,//(changed by maimoona from 6-9) //if a submenu has at least this many items it will be divided in 2 columns
    tripleColumn  : 12, //if a submenu has at least this many items it will be divided in 3 columns
    hoverClass  : 'sfHover',
    delay    : 10, //make sure menus only disappear when intended, 500ms is advised by Jacob Nielsen
    animationShow  : {height:'show'},
    speedShow    : 50,//(changed by maimoona from 600)
    easingShow      : sooperEasingShow,
    animationHide  : {height:'hide',opacity:'hide'},
    speedHide    : 50,//(changed by maimoona from 200)
