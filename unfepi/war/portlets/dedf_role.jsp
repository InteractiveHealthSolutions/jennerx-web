...
<table class="denform-h">
        <tr>
            ...
            <input type="text" name="rolename" readonly="readonly" value="<c:out value="${status.value}"/>"/>
        ...
        <tr>
            ...
            <tr>
            <td>
				<select id="selectedPerms" name="selectedPerms" multiple="multiple" class="listMedium">
					<c:forEach items="${rolePermissions}" var="pr">
						<option >${pr.permissionname}</option>
					</c:forEach>
				</select>
			</td>
			<td>
