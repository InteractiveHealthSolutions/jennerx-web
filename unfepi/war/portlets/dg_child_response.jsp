...
<table >
   ...
   <c:forEach items="${model.datalist}" var="resp">
   	 <tr>
			...
			<a id="${resp.responseId}anc" class="linkiconS iconexpand" onclick="expandD('${resp.class.name}', ${resp.responseId});" value="+"></a>
            ...
            <td><c:out value="${resp.eventId}"></c:out></td>
