...
public class VaccineScheduleOLDOLD {
	...
	public VaccineScheduleOLDOLD() {
	}
	
	public VaccineScheduleOLDOLD(Integer childId, Vaccine vaccine, Date assigned_duedate, Date vaccination_date, Integer center, VaccineStatusType status) {
